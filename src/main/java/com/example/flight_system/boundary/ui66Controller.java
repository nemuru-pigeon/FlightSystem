...
public class ui66Controller {
    ...
    void nextP6(ActionEvent event) {
        if(location == 0){
            ...
            if(location<=28){
                ...
                mainControl1.selectSeat("economy",location-28);
            }
    ...
    public void initialize(){
        ...
        System.out.println(change1.length);
        ...
        for (i = 0; i<change.length; i++){
            ...
            Button scoreImageView = (Button) background.lookup("#a"+(i+29));
            if(temp){
                scoreImageView.setStyle("-fx-background-color:#464646;");
                scoreImageView.setDisable(true);
            }
